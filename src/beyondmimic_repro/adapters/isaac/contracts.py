...
ISAAC_UNAVAILABLE_MESSAGE = "Isaac Sim runtime is unavailable. Run this entrypoint on the RTX 4090 Isaac Lab host."


@dataclass(frozen=True)
class IsaacRunConfig:
    """Common CLI options for RTX 4090 Isaac Lab entrypoints."""
